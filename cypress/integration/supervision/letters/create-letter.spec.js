  ...
  it(
    ...
    () => {
      ...
      cy.get('@orderId').then(orderId => {
        cy.get('@clientId').then(clientId => {
          cy.visit(`/supervision-api/v1/clients/${clientId}/orders/${orderId}/drafts/create/template`);
        });
      });
      ...
      cy.get('.smart__action > ng-component:nth-child(2) > div:nth-child(1) > draft-select-recipients:nth-child(1) > div:nth-child(1) > div:nth-child(1) > h2:nth-child(1)')
        .as('recipientHeader')
